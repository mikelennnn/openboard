...
public final class InputLogic {
    ...
    private void handleFormalTextKey() {
        ...
        final String originalText = textBeforeCursor.toString();
        final int originalLength = originalText.length();
        final String prompt = "Reformula el siguiente texto para que suene extremadamente "
                + "formal, elegante y profesional, con ortografia y gramatica perfectas. "
                + "Puedes agregar palabras, elaborar mas las ideas y extender el texto si "
                + "hace falta para que suene mas refinado, pero conserva el mismo idioma, "
                + "el mensaje y la intencion original. Responde unicamente con el texto "
                + "reformulado, sin explicaciones ni comillas adicionales:\n\n" + originalText;
    ...
    private void handleDetailTextKey() {
        ...
        final String originalText = textBeforeCursor.toString();
        final int originalLength = originalText.length();
        final String prompt = "Amplia y explica con mas detalle el siguiente texto, para "
                + "que se entienda mejor, agregando informacion o contexto util si hace "
                + "falta. No cambies el tono del texto original (si es serio, mantenlo "
                + "serio; si es casual, mantenlo casual), solo hazlo mas detallado y claro. "
                + "Conserva el mismo idioma. Responde unicamente con el texto ampliado, "
                + "sin explicaciones ni comillas adicionales:\n\n" + originalText;
