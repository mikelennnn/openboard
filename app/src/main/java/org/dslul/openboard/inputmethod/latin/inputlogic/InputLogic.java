...
public final class InputLogic {
    ...
    private void handleAiAssistKey() {
        // DIAGNOSTICO: esto escribe un texto de prueba directamente, para confirmar
        // que el codigo se ejecuta (los Toast a veces los bloquea el sistema).
        mConnection.commitText("[IA-CLIC-OK]", 1);
        return;
        /*
        android.widget.Toast.makeText(mLatinIME, "Boton IA presionado", android.widget.Toast.LENGTH_SHORT)
                .show();
