...
public final class KeyboardSwitcher implements KeyboardState.SwitchActions {
    ...
    public void showFontPanel(final String text, final int textLength) {
        ...
        mClipboardHistoryView.setVisibility(View.GONE);
        mClipboardHistoryView.stopClipboardHistory();
        mFontPanelView.open(mLatinIME, text, textLength);
        mFontPanelView.setVisibility(View.VISIBLE);
    }

    /**
     * Vuelve al teclado normal desde el panel de fuentes.
     */
    public void hideFontPanel() {
        if (mFontPanelView == null) {
            return;
        }
        mFontPanelView.setVisibility(View.GONE);
        mMainKeyboardFrame.setVisibility(View.VISIBLE);
        mKeyboardView.setVisibility(View.VISIBLE);
    }
